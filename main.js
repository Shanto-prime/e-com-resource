/* =====================================================================
   ECOBAZAR — main.js
   Shared client-side behaviors for every page:
...
(function () {
    ...
    document.querySelectorAll("[data-quick-close]").forEach(function (b) {
        b.addEventListener("click", closeQuick);
    });
    if (quickBackdrop) {
    ...
    /* ---------- blog: filter sidebar toggle (mobile) ---------- */
    var filterBtn = document.querySelector("[data-filter-toggle]");
    var blogSidebar = document.getElementById("blogSidebar");
    if (filterBtn && blogSidebar) {
        filterBtn.addEventListener("click", function () {
            blogSidebar.classList.toggle("hidden");
        });
    }
    ...
    document.querySelectorAll("[data-pwd-toggle]").forEach(function (btn) {
        btn.addEventListener("click", function () {
            ...
            btn.classList.toggle("text-primary", show);
            btn.setAttribute(
                "aria-label",
    ...
    tabBtns.forEach(function (btn) {
        btn.addEventListener("click", function () {
            ...
            document.querySelectorAll("[data-tab-panel]").forEach(function (p) {
                p.classList.toggle(
                    "hidden",
                    p.getAttribute("data-tab-panel") !== name,
                );
            });
        });
    });
